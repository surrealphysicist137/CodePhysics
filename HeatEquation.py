...
print("This program simulates the heat flow in a rod.")
print("=================================================")
print("Assumptions: ")
print("1. The rod is one-dimensional and has a uniform cross-sectional area.")
print("2. The thermal diffusivity is constant throughout the rod.") 
print("3. The initial temperature distribution is uniform across the rod.")
print("4. The boundary conditions are fixed temperatures at both ends of the rod.")
print("5. There is no internal heat generation within the rod.")
print("6. The rod is an isolated system.")
print("=================================================")
# Parameters
