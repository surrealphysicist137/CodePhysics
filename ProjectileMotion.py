...
print("This program calculates the trajectory of a projectile launched with air resistance and finds the optimal launch angle for maximum range.")
print("========================================================================")
print("Assumptions: ")
print("1. Only the force of gravity and air resistance act on the projectile.")
print("2. Air resistance is modelled as quadratic drag.")
print("3. The drag coefficient and mass of the projectile are constant.")
print("4. The projectile is launched from a specified initial height.")
print("Relativistic and quantum effects are not considered.")
print("========================================================================")
